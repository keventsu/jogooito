...
public class Tabuleiro {
	...
	public void gerarCampos() {
		campoCimaEsquerda = new Campo(Integer.valueOf(1), this);
		campoCimaMeio = new Campo(Integer.valueOf(2), this);
		campoCimaDireita = new Campo(Integer.valueOf(3), this);
		campoMeioEsquerda = new Campo(Integer.valueOf(4), this);
		campoMeio = new Campo(Integer.valueOf(8), this);
		campoMeioDireita = new Campo(Integer.valueOf(6), this);
		campoBaixoEsquerda = new Campo(Integer.valueOf(7), this);
		campoBaixoMeio = new Campo(Integer.valueOf(5), this);
		campoBaixoDireita = new Campo(Integer.valueOf(0), this);

		associarVizinhos();
		setPonteiro(campoBaixoDireita);
	}
